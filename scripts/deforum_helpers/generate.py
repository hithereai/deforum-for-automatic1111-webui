...
def generate_inner(args, keys, anim_args, loop_args, controlnet_args, root, frame = 0, return_sample=False, sampler_name=None):
    ...
    # this is the first pass
        ...
        if is_controlnet_enabled(controlnet_args):
            process_with_controlnet(p_txt, args, anim_args, loop_args, controlnet_args, root, keys, is_img2img=False, frame_idx=frame+1)
    ...
    if processed is None:
        ...
        if is_controlnet_enabled(controlnet_args):
            process_with_controlnet(p, args, anim_args, loop_args, controlnet_args, root, keys, is_img2img=True, frame_idx=frame+1)
