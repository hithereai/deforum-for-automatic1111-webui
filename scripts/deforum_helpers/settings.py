...
class DeforumTQDM:
    def __init__(self, args, anim_args, parseq_args, video_args, controlnet_args):
        self._tqdm = None
        self._args = args
    ...
    def reset(self):
        ...
        keys = DeformAnimKeys(self._anim_args, self._controlnet_args) if not use_parseq else ParseqAnimKeys(self._parseq_args, self._anim_args, self._video_args, mute=True)
