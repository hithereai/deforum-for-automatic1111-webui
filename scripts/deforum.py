...
def on_ui_settings():
    ...
    shared.opts.add_option("deforum_save_gen_info_as_srt_params", shared.OptionInfo(['Noise Schedule'], "Choose which animation params are to be saved to the .srt file", gr.CheckboxGroup, {"interactive": True, "choices": choice_list}, section=section))  
